return {
    ...
    config = function()
        ...
        keyset("i", "<TAB>", 'coc#pum#visible() ? coc#pum#next(1) : v:lua.check_back_leader() ? "<TAB>" : coc#refresh()',
            opts)
        ...
        keyset("i", "<F12>", "<Plug>(coc-definition)", { silent = true })
        ...
        keyset("i", "<C-k><C-k>", '<C-o><CMD>lua _G.show_docs()<CR>', { silent = true })
        ...
        keyset("i", "<C-r><C-r>", "<C-o><Plug>(coc-rename)", { silent = true })
        ...
        keyset("i", "<M-CR>", "<Plug>(coc-codeaction-cursor)", opts)
        ...
        keyset("n", "<C-s>r", "<Plug>(coc-range-select)", { silent = true })
        keyset("x", "<C-s>r", "<Plug>(coc-range-select)", { silent = true })
